...
* 2. [Importation of the module](#importation-of-the-module)
* 3. [Python Regex Features](#python-regex-features)
    * 3.1. [Compiling Regular Expressions](#compiling-regular-expressions)
    * 3.2. [Find first match](#find-first-match)
    * 3.3. [Find All Matches](#find-all-matches)
    * 3.4. [Find and Replace](#find-and-replace)
    * 3.5. [Split](#split)
* 4. [Python Regex Language](#python-regex-language)
    * 4.1. [Specials characters of RE](#specials-characters-of-re)
    * 4.2. [Text Exploitation](#text-exploitation)
        * 4.2.1. [Matching a single character](#matching-a-single-character)
        * 4.2.2. [Flags](#flags)
        * 4.2.3. [Control Characters](#control-characters)
        * 4.2.4. [Character Classes](#character-classes)
        * 4.2.5. [Groups](#groups)
    * 4.3. [Other](#other)
* 5. [Python Regex Engine - Behind the scenes](#python-regex-engine---behind-the-scenes)
    * 5.1. [One character at a time](#one-character-at-a-time)
    * 5.2. [Left to right](#left-to-right)
    * 5.3. [Greedy and Lazy](#greedy-and-lazy)
    * 5.4. [Look ahead and Look behing](#look-ahead-and-look-behing)
* 6. [Regular Expressions Applications in Data Science](#regular-expressions-applications-in-data-science)
    * 6.1. [Web-Scraping and Data Collection](#web-scraping-and-data-collection)
    * 6.2. [Text Preprocessing](#text-preprocessing)
    * 6.3. [Resources](#resources)
    * 6.4. [Further Reading](#further-reading)
